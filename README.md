...
Cheena Malhotra's marketplace of Copilot App plugins. Add this repo (or its
local path while developing) as a marketplace source in Copilot App:
Plugins -> Manage marketplaces -> Add source.
